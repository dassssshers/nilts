...
const _description = '`VoidCallback` type is defined in Flutter SDK.';
...
class DefinedVoidCallbackType extends AnalysisRule {
  /// Create a new instance of [DefinedVoidCallbackType].
  DefinedVoidCallbackType()
    : super(
        name: ruleName,
  ...
  static const String ruleName = 'defined_void_callback_type';

  /// The lint code for this rule.
  static const LintCode code = LintCode(
    ruleName,
    _description,
    correctionMessage: 'Replace with VoidCallback',
  );
...
/// A class for fixing `defined_void_callback_type` rule.
///
/// This fix replaces `void Function()` with `VoidCallback`.
class ReplaceWithVoidCallback extends ResolvedCorrectionProducer {
  /// Create a new instance of [ReplaceWithVoidCallback].
  ReplaceWithVoidCallback({required super.context});

  static const _fixKind = FixKind(
    'nilts.fix.replaceWithVoidCallback',
    FixKindPriority.replaceWithVoidCallback,
